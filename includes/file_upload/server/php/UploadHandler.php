...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/user_'.$_SESSION['user_id']."/meleti_".$_SESSION['meleti_id']."/",
            'upload_url' => $this->get_full_url().'/files/user_'.$_SESSION['user_id']."/meleti_".$_SESSION['meleti_id']."/",
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
