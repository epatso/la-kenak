...
Εάν πληρώσατε για αυτό το λογισμικό απευθυνθείτε στο δημιουργό στα στοιχεία που αναφέρονται στην κορυφή κάθε αρχείου.<br/>
...
echo "Η σελίδα φόρτωσε σε ".$total_time." δευτερόλεπτα.";
    ...
    echo "<br/>Δεν βρέθηκε σύνδεση στο διαδίκτυο. Συγκεκριμένες επιλογές δεν λειτουργούν (πχ υπόβαθρα χαρτών google maps).";
