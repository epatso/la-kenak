...
<br/>
<div id="mthx_diafani_table"></div>
<div id="mthx_diafani_info"></div>
<script>
get_mthx_diafani();

//Εμφάνιση πίνακα με όλα τα ανοίγματα
function get_mthx_diafani(page){
page = typeof page !== 'undefined' ? page : 1;
	document.getElementById('wait').style.display="inline";
	//AJAX call
	var xmlhttp=new XMLHttpRequest();
	
	xmlhttp.open("GET","includes/functions_meleti_kelyfos.php?getmthxdiafani=1&page="+page ,true);
	xmlhttp.send();
	
	xmlhttp.onreadystatechange=function()  {
	if (xmlhttp.readyState==4 && xmlhttp.status==200) {
		document.getElementById("mthx_diafani_table").innerHTML=xmlhttp.responseText;
...
function mthx_diafani_getwalls(mthx_id,wall_id){
	mthx_id = typeof mthx_id !== 'undefined' ? mthx_id : 0;
	wall_id = typeof wall_id !== 'undefined' ? wall_id : 0;
	var prefix = "editmthx_diafani_";
		if(mthx_id==0){
			mthx_id=document.getElementById(prefix+"mthx_id").value;
		}

	//Εμφάνιση select για τους τοίχους ανάλογα με τον τύπο (ΖΩΝΕΣ η ΜΘΧ) και τη ζώνη. Εδώ ενδιαφέρουν οι ΜΘΧ
	var link2 = "includes/functions_meleti_general.php?getavailablewalls=1&type=1&zone_id="+mthx_id;
...
function mthx_diafani_getroofs(mthx_id,roof_id){
	mthx_id = typeof mthx_id !== 'undefined' ? mthx_id : 0;
	...
	//Εμφάνιση select για τις οροφές ανάλογα με τον τύπο (ΖΩΝΕΣ η ΜΘΧ) και τη ζώνη. Εδώ ενδιαφέρουν οι ΜΘΧ
	var link2 = "includes/functions_meleti_general.php?getavailableroofs=1&type=1&zone_id="+mthx_id;
	var xmlhttp2=new XMLHttpRequest();
	xmlhttp2.open("GET",link2 ,true);
	xmlhttp2.send();
	xmlhttp2.onreadystatechange=function()  {
...
function mthx_diafani_getwindows(u_id,u_id_no){
...
function form_mthx_diafani(id,page){
	page = typeof page !== 'undefined' ? page : 1;
var prefix = "editmthx_diafani_";

	if(id==0){
	mthx_diafani_getmthxs();
	document.getElementById(prefix+"mthx_id").selectedIndex = 0;
	document.getElementById("mthx_radio1").checked = true;
	mthx_diafani_getwalls();
	mthx_diafani_getroofs();
	mthx_diafani_belongs(1);
	...
	if(id!=0){
		var link = "includes/functions_meleti_general.php?get_iddata=1&table=meletes_mthx_diafani&id="+id;
		...
		if (xmlhttp.readyState==4 && xmlhttp.status==200) {
			var arr = JSON.parse(xmlhttp.responseText);	
				...
				if(arr["wall_id"]==0){
					...
					mthx_diafani_getroofs(arr["mthx_id"],arr["roof_id"]);
					document.getElementById("mthx_radio2").checked = true;
				}
				if(arr["roof_id"]==0){
					mthx_diafani_belongs(1);
					mthx_diafani_getroofs(arr["mthx_id"]);
					mthx_diafani_getwalls(arr["mthx_id"],arr["wall_id"]);
					document.getElementById("mthx_radio1").checked = true;
				}
				...
				mthx_diafani_getwindows(arr["u_id"],arr["u_id_no"]);
	...
	if(id!=0){
		button = '<button class="btn btn-warning" data-dismiss="modal" aria-hidden="true" onclick="submit_mthx_diafani('+id+','+page+');">Επεξεργασία</button>';
		edit_header = 'Επεξεργασία διαφανούς';
	}else{
		button = '<button class="btn btn-znx" data-dismiss="modal" aria-hidden="true" onclick="submit_mthx_diafani('+id+','+page+');">Προσθήκη</button>';
		edit_header = 'Προσθήκη διαφανούς';
	}
	document.getElementById("edit_button_mthx_diafani").innerHTML = button;
	document.getElementById("edit_header_mthx_diafani").innerHTML = edit_header;
	$("#modal_form_mthx_diafani").modal("show");
	modal_height();
}

//ΔΙΑΓΡΑΦΗ
function formdel_mthx_diafani(id,page){
	var button = '<button class="btn btn-danger" data-dismiss="modal" aria-hidden="true" onclick="del_mthx_diafani('+id+','+page+');">Διαγραφή</button>';
	document.getElementById("del_button_mthx_diafani").innerHTML = button;
	$("#modal_del_mthx_diafani").modal("show");
}

//Υποβολή της φόρμας
//Ανάλογα με το id γίνεται προσθήκη ή επεξεργασία
function submit_mthx_diafani(id,page){
var prefix = "editmthx_diafani_";
	...
	link += "&table=meletes_mthx_diafani";
	link += "&action="+action;
	link += "&id="+id;
	link += "&values="+mthx_id+","+wall_id+","+roof_id+","+name+","+w+","+h+","+p+","+f;
	...
	xmlhttp.onreadystatechange=function()  {
	if (xmlhttp.readyState==4 && xmlhttp.status==200) {
		document.getElementById("mthx_diafani_info").innerHTML=xmlhttp.responseText;
		document.getElementById('wait').style.display="none";
		get_mthx_diafani(page);
		get_meleti_n();
	}}
}

//Διαγραφή
function del_mthx_diafani(id,page){
	var link = "includes/functions_meleti_general.php?del_iddata=1&table=meletes_mthx_diafani&id="+id;
	document.getElementById('wait').style.display="inline";
	//AJAX call
	var xmlhttp=new XMLHttpRequest();
...
function mthx_diafani_changemthx(){
var prefix = "editmthx_diafani_";
var mthx_id = document.getElementById(prefix+"mthx_id").value;
	mthx_diafani_getwalls(mthx_id);
	mthx_diafani_getroofs(mthx_id);
}

//Αλλαγή select τοίχων/οροφών
function mthx_diafani_belongs(n){
var prefix = "editmthx_diafani_";
	if(n==1){
...
var parameters = "";
	...
	if(type==1){
	mthx_diafani_findwind();
	}
}

//Εύρεση συντελεστή αερισμού
function mthx_diafani_findwind(){
var prefix = "editmthx_diafani_";
	var typew = document.getElementById(prefix+"type").value;
	var plaisio = document.getElementById(prefix+"plaisio").value;
	var yalopinakas = document.getElementById(prefix+"yalopinakas").value;
...
function mthx_diafani_changetype(){
var prefix = "editmthx_diafani_";
var type = document.getElementById(prefix+"type").value;
var plaisio_txt;
	if(type==0){
...
function mthx_diafani_changeplaisio(){
var prefix = "editmthx_diafani_";
var plaisio = document.getElementById(prefix+"plaisio").value;
...
function mthx_diafani_pistopoiisi(){
var prefix = "editmthx_diafani_";
	var yalopinakas = document.getElementById(prefix+"yalopinakas").value;
...
function mthx_diafani_psi_img(typos){
	var prefix,type;
	if(typos==1){
	prefix = "editmthx_diafani_psil";
	type="lp";
	}
	if(typos==2){
	prefix = "editmthx_diafani_psia";
	type="yp";
	}
	var no = document.getElementById(prefix).value;
	
	var img = "<img src=\"images/thermo/"+type+"/"+type+no+".jpg\">";
	document.getElementById("editmthx_diafani_psi_img").innerHTML = img;	
}

function mthx_diafani_draw(){
var prefix = "editmthx_diafani_";
	var name = document.getElementById(prefix+"name").value;
...
<!-- ###################### Κρυφό modal_form_mthx_diafani για εμφάνιση ###################### -->
<div id="modal_form_mthx_diafani" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
<div class="modal-dialog">
<div class="modal-content">
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
		<h6 id="myModalLabel"><span id="edit_header_mthx_diafani"></span></h6>
	</div>
	...
	<div class="tabbable tabs-left">
		...
		<li class="active"><a href="#tab_modaldiafani_mthx_1" data-toggle="tab">Άνοιγμα</a></li>
		<li><a href="#tab_modaldiafani_mthx_2" data-toggle="tab">Ψ/Αερισμός</a></li>
		<li><a href="#tab_modaldiafani_mthx_3" data-toggle="tab">Σκιάσεις</a></li>
		<li><a href="#tab_modaldiafani_mthx_4" data-toggle="tab" onclick="mthx_diafani_draw();">Προεπισκόπηση</a></li>
		</ul>
		
		<div class="tab-content">
			
			<div class="tab-pane active" id="tab_modaldiafani_mthx_1">
	
	<table class="table table-bordered table-condensed">
		<tr class="info"><td colspan="2">Διαφανή</td></tr>
		<tr>
		<td style="width:50%;">
			<div id="editmthx_diafani_divthesi">
				<table class="table table-bordered table-condensed">
				<tr class="warning">
					...
					<td>
						<div class="input-group">
							<span class="input-group-addon">
								<span class="tip-top" href="#" title="Επιλέξτε ΜΘΧ για να εμφανιστούς οι διαθέσιμοι τοίχοι, οροφές"><i class="fa fa-cube"></i> ΜΘΧ</span>
							</span>
							<select class="form-control input-sm" id="editmthx_diafani_mthx_id" onchange="mthx_diafani_changemthx();">
				...
				<tr>
					<td>
						<div class="row">
							<div class="col-md-6">
								<input class="radio-inline" type="radio" id="mthx_radio1" name="flowdir" value="1" onclick="mthx_diafani_belongs(1);"/> 
								<a class="tooltipui" href="#" title="Ανήκει σε τοίχο">Τοίχου</a>
							</div>
							<div class="col-md-6">
								<input class="radio-inline" type="radio" id="mthx_radio2" name="flowdir" value="2" onclick="mthx_diafani_belongs(2);"/> 
					...
					<div class="row">
						<div class="col-md-6">
							<div class="input-group has-success">
								...
								<select class="form-control input-sm" id="editmthx_diafani_wall_id">
									<option value=0></option>
								</select>
							</div>
						</div>
						<div class="col-md-6">
							<div class="input-group has-warning">
								...
								<select class="form-control input-sm" id="editmthx_diafani_roof_id">
									<option value=0></option>
								</select>
							</div>
						</div>
				...
				<tr>
					<td>
						<div class="input-group">
							...
							<input class="form-control input-sm" type="text" id="editmthx_diafani_name">
						</div>
					</td>
				</tr>
				</table>
			...
			<div id="editmthx_diafani_divdimensions">
				<table class="table table-bordered table-condensed">
					<tr class="warning">
					...
					<tr>
						<td>
							<div class="input-group">
								...
								<input class="form-control input-sm" type="text" id="editmthx_diafani_w">
					...
					<tr>
						<td>
							<div class="input-group">
								...
								<input class="form-control input-sm" type="text" id="editmthx_diafani_h">
								<span class="input-group-addon">m</span>
							</div>
						</td>
					</tr>
					<tr>
						<td>
							<div class="input-group">
								...
								<input class="form-control input-sm" type="text" id="editmthx_diafani_p">
								<span class="input-group-addon">m</span>
							</div>
						</td>
					</tr>
					<tr>
						<td>
							<div class="input-group">
								...
								<input class="form-control input-sm" type="text" id="editmthx_diafani_f">
							</div>
						</td>
					</tr>
					<tr>
						<td>
							<div class="input-group">
								...
								<input class="form-control input-sm" type="text" id="editmthx_diafani_apoar">
								<span class="input-group-addon">m</span>
							</div>
						</td>
					</tr>
		...
		<td>
				...
				<table class="table table-bordered table-condensed">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="input-group">
									...
									<select class="form-control input-sm" id="editmthx_diafani_u_id" onchange="mthx_diafani_u(); mthx_diafani_getwindows();">
							...
							<div class="col-md-6">
								<div class="input-group">
									...
									<select class="form-control input-sm" type="text" id="editmthx_diafani_u_id_no" onchange="mthx_diafani_u();"/>
					...
					<tr>
						<td>
								...
								<input type="text" id="editmthx_diafani_u" class="form-control input-sm" />
			...
			<div id="editmthx_diafani_divtype">
				<table class="table table-bordered table-condensed">
					...
					<tr>
						<td>
							<div class="input-group">
								...
								<select class="form-control input-sm" id="editmthx_diafani_type" onchange="mthx_diafani_changetype(); mthx_diafani_u();">
					...
					<tr>
						<td>
							<div class="input-group">
								...
								<select class="form-control input-sm" id="editmthx_diafani_prostasia" onchange="mthx_diafani_u();">
					...
					<tr>	
						<td>
							<div class="input-group">
								...
								<select class="form-control input-sm" id="editmthx_diafani_plaisio" onchange="mthx_diafani_changeplaisio(); mthx_diafani_u();">
									<option value=0></option>
								</select>
							</div>
						</td>
					...
					<tr>
						<td>
							<div class="input-group">
								...
								<select class="form-control input-sm" id="editmthx_diafani_plaisioper" onchange="mthx_diafani_u();">
					...
					<tr>
						<td>
							<div class="input-group">
								...
								<select class="form-control input-sm" id="editmthx_diafani_yalopinakas" onchange="mthx_diafani_u();">
									<option value=0></option>
								</select>
							</div>
						</td>
			...
			<div id="editmthx_diafani_divaktinovolia">
				<table class="table table-bordered table-condensed">
					<tr class="warning">
					...
					<tr>
						<td>
							<div class="input-group">
								...
								<input class="form-control input-sm" type="text" id="editmthx_diafani_g_w">
							</div>
						</td>
					</tr>
					<tr>	
						<td style="text-align:center;">
							<div class="row">
								...
								<div class="col-md-10">
									<div class="input-group">
										<label class="checkbox"><input type="checkbox" id="editmthx_diafani_passive">Παθητικά ηλιακά άμεσου κέρδους</label>
								</div>
								</div>
							</div>
						</td>
	...
	<div class="tab-pane" id="tab_modaldiafani_mthx_2">
		...
		<td style="width:50%;">
			...
			<div id="editmthx_diafani_divpsi">
				<table class="table table-bordered table-condensed">
				<tr class="warning">
				...
				<tr>
					<td>
						<div class="input-group">
							...
							<select class="form-control input-sm" id="editmthx_diafani_psil" onchange="mthx_diafani_psi_img(1);">
								<?php
				...
				<tr>
					<td>
						<div class="input-group">
							...
							<select class="form-control input-sm" id="editmthx_diafani_psia" onchange="mthx_diafani_psi_img(2);">
								<?php
			...
			<div id="editmthx_diafani_divwind">
				<table class="table table-bordered table-condensed">
				<tr class="warning">
				...
				<tr>
					<td>
						<div class="input-group">
							...
							<select class="form-control input-sm" id="editmthx_diafani_pistopoiisi" onchange="mthx_diafani_findwind();">
				...
				<tr>
					<td>
						<div class="input-group">
							...
							<input class="form-control input-sm" type="text" id="editmthx_diafani_wind">
		...
		<td style="width:50%;">
			<div id="editmthx_diafani_psi_img"></div>
		</td>
		</tr>
		</table>
	...
	<div class="tab-pane" id="tab_modaldiafani_mthx_3">
	<div id="adiafani_ck_f">
	<form class="form-inline">
		<label class="checkbox inline"><input type="checkbox" id="editmthx_diafani_ck_fhor" onchange="mthx_diafani_showf();">F<sub>hor</sub></label>
		<label class="checkbox inline"><input type="checkbox" id="editmthx_diafani_ck_fov" onchange="mthx_diafani_showf();">F<sub>ov</sub></label>
		<label class="checkbox inline"><input type="checkbox" id="editmthx_diafani_ck_fovt" onchange="mthx_diafani_showf();">F<sub>ovt</sub></label>
		<label class="checkbox inline"><input type="checkbox" id="editmthx_diafani_ck_ffin_l" onchange="mthx_diafani_showf();">F<sub>fin_l</sub></label>
		<label class="checkbox inline"><input type="checkbox" id="editmthx_diafani_ck_ffin_r" onchange="mthx_diafani_showf();">F<sub>fin_r</sub></label>
		<label class="checkbox inline"><input type="checkbox" id="editmthx_diafani_ck_fsh" onchange="mthx_diafani_showf();">F<sub>sh</sub></label>
	</form>
	</div>
	<div id="diafani_ck_f1">
		<select class="form-control input-sm" id="editmthx_diafani_f_type" onchange="mthx_diafani_changef();" >
		...
		<div id="editmthx_diafani_fhor" style="display:none;">
					<table class="table table-bordered table-condensed">
						<tr class="info">
							<td colspan=2>
						...
						<tr>
							<td width=50%>
								...
								<input type="text" id="editmthx_diafani_fhor_e" class="form-control input-sm" />
								<span class="input-group-addon">m</span>
								</div>
							</td>
							<td>
								...
								<input type="text" id="editmthx_diafani_fhor_h" class="form-control input-sm" />
								<span class="input-group-addon">m</span>
								</div>
							</td>
						</tr>
				...
				<div id="editmthx_diafani_fov" style="display:none;">
					<table class="table table-bordered table-condensed">
						<tr class="info">
							<td>
						...
						<tr>
							<td>
								...
								<input type="text" id="editmthx_diafani_fov_l" class="form-control input-sm" />
								<span class="input-group-addon">m</span>
								</div>
							</td>
						</tr>
				...
				<div id="editmthx_diafani_fovt" style="display:none;">
					<table class="table table-bordered table-condensed">
						<tr class="info">
							<td colspan=2>
						...
						<tr>
							<td>
								...
								<input type="text" id="editmthx_diafani_fovt_l" class="form-control input-sm" />
								<span class="input-group-addon">m</span>
								</div>
							</td>
							<td>
								...
								<input type="text" id="editmthx_diafani_fovt_h" class="form-control input-sm" />
								<span class="input-group-addon">m</span>
								</div>
							</td>
						</tr>
				...
				<div id="editmthx_diafani_ffin_l" style="display:none;">
					<table class="table table-bordered table-condensed">
						<tr class="info">
							<td colspan="2">
						...
						<tr>
							<td>
								...
								<input type="text" id="editmthx_diafani_ffin_l_dx" class="form-control input-sm" />
								<span class="input-group-addon">m</span>
								</div>
							</td>
							<td>
								...
								<input type="text" id="editmthx_diafani_ffin_l_w" class="form-control input-sm" />
								<span class="input-group-addon">m</span>
								</div>
							</td>
						</tr>
				...
				<div id="editmthx_diafani_ffin_r" style="display:none;">
					<table class="table table-bordered table-condensed">
						<tr class="info">
							<td colspan="2">
						...
						<tr>
							<td>
								...
								<input type="text" id="editmthx_diafani_ffin_r_dx" class="form-control input-sm" />
								<span class="input-group-addon">m</span>
								</div>
							</td>
							<td>
								...
								<input type="text" id="editmthx_diafani_ffin_r_w" class="form-control input-sm" />
								<span class="input-group-addon">m</span>
								</div>
							</td>
						</tr>
				...
				<div id="editmthx_diafani_fsh" style="display:none;">
					<table class="table table-bordered table-condensed">
						<tr class="info">
							<td colspan="3">
						...
						<tr>
							<td>
								...
								<select id="editmthx_diafani_fsh_type" class="form-control input-sm" />
							...
							<td>
								...
								<input type="text" id="editmthx_diafani_fsh_l" class="form-control input-sm" />
								<span class="input-group-addon">m</span>
								</div>
							</td>
							<td>
								...
								<input type="text" id="editmthx_diafani_fsh_h" class="form-control input-sm" />
								<span class="input-group-addon">m</span>
								</div>
							</td>
						</tr>
	...
	<div class="tab-pane" id="tab_modaldiafani_mthx_4">
		<div class="thumbnail">
		<div id="editmthx_diafani_preview1">
...
<div class="modal-footer">	
	<span id="edit_button_mthx_diafani"></span>
...
<!-- ###################### Κρυφό modal_del_mthx_diafani για εμφάνιση ###################### -->
<div id="modal_del_mthx_diafani" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
<div class="modal-dialog">
<div class="modal-content">
<div class="modal-header">
	<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
...
<div class="modal-footer">	
	<span id="del_button_mthx_diafani"></span>
	<button class="btn" data-dismiss="modal" aria-hidden="true">Άκυρο</button>
</div>
</div>
</div>
