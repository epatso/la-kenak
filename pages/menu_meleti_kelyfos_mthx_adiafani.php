...
<br/>
<div id="mthx_adiafani_table"></div>
<div id="mthx_adiafani_info"></div>
<script>
get_mthx_adiafani();

//Εμφάνιση πίνακα με όλες τις μονάδες παραγωγής του χρήστη
function get_mthx_adiafani(page){
page = typeof page !== 'undefined' ? page : 1;
	document.getElementById('wait').style.display="inline";
	//AJAX call
	var xmlhttp=new XMLHttpRequest();
	
	xmlhttp.open("GET","includes/functions_meleti_kelyfos.php?getmthxadiafani=1&page="+page ,true);
	xmlhttp.send();
	
	xmlhttp.onreadystatechange=function()  {
	if (xmlhttp.readyState==4 && xmlhttp.status==200) {
		document.getElementById("mthx_adiafani_table").innerHTML=xmlhttp.responseText;
...
function mthx_adiafani_getmthxs(mthx_id){
type = typeof type !== 'undefined' ? type : 0;
var prefix = "editmthx_adiafani_";

//Εμφάνιση select ανάλογα με τον τύπο (ΖΩΝΕΣ η ΜΘΧ). Εδώ ενδιαφέρουν MΘΧ
var link1 = "includes/functions_meleti_general.php?getavailablezones=1&type=1";
...
if (xmlhttp1.readyState==4 && xmlhttp1.status==200) {
	...
	document.getElementById(prefix+"mthx_id").innerHTML = xmlhttp1.responseText;
	if(mthx_id!=0){
	document.getElementById(prefix+"mthx_id").value = mthx_id;
	}
}}
}

//Εμφάνιση του modal για την εισαγωγή ή επεξεργασία
function form_mthx_adiafani(id,page){
	page = typeof page !== 'undefined' ? page : 1;
var prefix = "editmthx_adiafani_";
	var yp,dok,syr;
	if(id==0){
	mthx_adiafani_getmthxs();
	...
	mthx_adiafani_changetype();
	
	document.getElementById(prefix+"l").value = "";
	document.getElementById(prefix+"h").value = "";
	document.getElementById(prefix+"d").value = "";
	document.getElementById(prefix+"dy").value = "";
	document.getElementById(prefix+"dx").value = "";
	document.getElementById(prefix+"roof").value = "";
	document.getElementById(prefix+"draw_order").value = "";
	...
	document.getElementById(prefix+"per").value = 0;
	mthx_adiafani_per();
	
	//Υποστυλώματα
	document.getElementById(prefix+"yp_u").value = "";
	document.getElementById(prefix+"yp_u_id").selectedIndex = 0;
	mthx_adiafani_yp_u();
	var yp_counter = document.getElementById(prefix+"yp_counter").value;
	for(var i=2;i<=yp_counter;i++){
		rem_mthx_yp(i);
	}
	document.getElementById(prefix+"yp_1").value = "";
	...
	document.getElementById(prefix+"dok_u_id").selectedIndex = 0;
	mthx_adiafani_dok_u();
	var dok_counter = document.getElementById(prefix+"dok_counter").value;
	for(var i=2;i<=dok_counter;i++){
		rem_mthx_dok(i);
	}
	document.getElementById(prefix+"dok_1").value = "";
	...
	document.getElementById(prefix+"syr_u_id").selectedIndex = 0;
	mthx_adiafani_syr_u();
	var syr_counter = document.getElementById(prefix+"syr_counter").value;
	for(var i=2;i<=syr_counter;i++){
		rem_mthx_syr(i);
	}
	document.getElementById(prefix+"syr_w_1").value = "";
	document.getElementById(prefix+"syr_h_1").value = "";
	...
	if(id!=0){
		...
		if (xmlhttp.readyState==4 && xmlhttp.status==200) {
			var arr = JSON.parse(xmlhttp.responseText);	
				...
				mthx_adiafani_getmthxs(arr["mthx_id"]);
	...
	if(id!=0){
		button = '<button class="btn btn-warning" data-dismiss="modal" aria-hidden="true" onclick="submit_mthx_adiafani('+id+','+page+');">Επεξεργασία</button>';
		edit_header = 'Επεξεργασία τοίχου';
	}else{
		button = '<button class="btn btn-znx" data-dismiss="modal" aria-hidden="true" onclick="submit_mthx_adiafani('+id+','+page+');">Προσθήκη</button>';
		edit_header = 'Προσθήκη τοίχου';
	}
	document.getElementById("edit_button_mthx_adiafani").innerHTML = button;
	document.getElementById("edit_header_mthx_adiafani").innerHTML = edit_header;
	$("#modal_form_mthx_adiafani").modal("show");
	modal_height();
}

//Εμφάνιση του modal διαγραφής
function formdel_mthx_adiafani(id,page){
	var button = '<button class="btn btn-danger" data-dismiss="modal" aria-hidden="true" onclick="del_mthx_adiafani('+id+','+page+');">Διαγραφή</button>';
	document.getElementById("del_button_mthx_adiafani").innerHTML = button;
	$("#modal_del_mthx_adiafani").modal("show");
}

//Υποβολή της φόρμας
//Ανάλογα με το id γίνεται προσθήκη ή επεξεργασία
function submit_mthx_adiafani(id,page){
var prefix = "editmthx_adiafani_";
	...
	link += "&table=meletes_mthx_adiafani";
	link += "&action="+action;
	link += "&id="+id;
	link += "&values="+mthx_id+","+name+","+g+","+g_type+","+b+","+type+","+l+","+h+","+d+","+dy+","+dx;
	...
	xmlhttp.onreadystatechange=function()  {
	if (xmlhttp.readyState==4 && xmlhttp.status==200) {
		document.getElementById("mthx_adiafani_info").innerHTML=xmlhttp.responseText;
		document.getElementById('wait').style.display="none";
		get_mthx_adiafani(page);
		get_meleti_n();
	}}
}

//Διαγραφή
function del_mthx_adiafani(id,page){
	var link = "includes/functions_meleti_general.php?del_iddata=1&table=meletes_mthx_adiafani&id="+id;
	document.getElementById('wait').style.display="inline";
	//AJAX call
	var xmlhttp=new XMLHttpRequest();
...
function mthx_adiafani_changetype(){
var prefix = "editmthx_adiafani_";
var type = document.getElementById(prefix+"type").value;
...
function mthx_adiafani_changef(){
var prefix = "editmthx_adiafani_";
...
function mthx_adiafani_psi_img(typos){
	var prefix;
	if(typos==1){
	prefix = "editmthx_adiafani_psi_dap_";
	}
	if(typos==2){
	prefix = "editmthx_adiafani_psi_or_";
	}
	if(typos==3){
	prefix = "editmthx_adiafani_psi_yp_";
	}
	if(typos==4){
	prefix = "editmthx_adiafani_psi_dok_";
	}
	if(typos==5){
	prefix = "editmthx_adiafani_psi_syr_";
	}
	...
	document.getElementById("editmthx_adiafani_psi_img").innerHTML = img;	
}

//Αλλαγή διαθέσιμων θερμογεφυρών ανάλογα με τον τύπο
function mthx_adiafani_psi_type(typos, u){
	var prefix;
	if(typos==1){
	prefix = "editmthx_adiafani_psi_dap_";
	}
...
function mthx_adiafani_draw(id){
	var prefix = "editmthx_adiafani_";
	var x1="includes/draw_wall.php?draw=3&zone=1&wall_id="+id;
	document.getElementById(prefix+"preview3").innerHTML = "<img width=100% src=\""+x1+"\" ></img>";
	
	var x2="includes/draw_wall.php?draw=1&zone=1&wall_id="+id;
	document.getElementById(prefix+"preview1").innerHTML = "<img width=100% src=\""+x2+"\" ></img>";
}

function mthx_adiafani_showimg(id){
	var x1="includes/draw_wall.php?draw=3&zone=1&wall_id="+id;
	document.getElementById("kelyfosimg").innerHTML = "<img height=300px src=\""+x1+"\" ></img>";
	$("#help_kelyfosimg").modal("show");
}

function mthx_adiafani_per(){
var prefix = "editmthx_adiafani_";
var per =  document.getElementById(prefix+"per").value;
	if(per==0){
...
function mthx_adiafani_help_per() {
var prefix = "editmthx_adiafani_";
...
function mthx_adiafani_use_per4() {
var prefix = "editmthx_adiafani_";
...
<!-- ###################### Κρυφό modal_form_mthx_adiafani για εμφάνιση ###################### -->
<div id="modal_form_mthx_adiafani" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
<div class="modal-dialog">
<div class="modal-content">
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
		<h6 id="myModalLabel"><span id="edit_header_mthx_adiafani"></span></h6>
	</div>

	<div class="modal-body">
<div class="tabbable tabs-left">
		<ul class="nav nav-mthx">
		<li class="active"><a href="#tab_modal_mthx_1" data-toggle="tab">Τοίχος</a></li>
		<li><a href="#tab_modal_mthx_2" data-toggle="tab">Φέρων</a></li>
		<li><a href="#tab_modal_mthx_3" data-toggle="tab">Συρόμενα</a></li>
		<li><a href="#tab_modal_mthx_4" data-toggle="tab">Σκιάσεις</a></li>
		<li><a href="#tab_modal_mthx_5" data-toggle="tab">Ψ</a></li>
		<li><a href="#tab_modal_mthx_6" data-toggle="tab" >Προεπισκόπηση</a></li>
		</ul>
		
		<div class="tab-content">
			
			<div class="tab-pane active" id="tab_modal_mthx_1">
				<table class="table table-bordered">
					...
					<tr>
						<td>
							<table class="table table-bordered table-condensed">
								...
								<tr>
									<td>
										...
										<span class="input-group-addon">
											<span class="tip-top" href="#" title="ΜΘΧ που ανήκει ο τοίχος"><i class="fa fa-cube"></i> ΜΘΧ</span>
										</span>
										<select class="form-control input-sm" id="editmthx_adiafani_mthx_id">
								...
								<tr>
									<td>
										...
										<input type="text" id="editmthx_adiafani_name" class="form-control" />
										</div>
									</td>
								</tr>
								<tr>
									<td>
										<div class="input-group">
										<span class="input-group-addon">
											<span class="tip-top" href="#" title="Τύπος επαφής τοιχοποιίας"><i class="fa fa-braille"></i> Τύπος</span>
										</span>
										<select class="form-control input-sm" id="editmthx_adiafani_type" onchange="mthx_adiafani_changetype();">
									...
									<div class="row">
										<div class="col-md-6">
											...
											<span class="input-group-addon">
												...
												<input type="text" id="editmthx_adiafani_g" class="form-control input-sm" />
											</div>
										</div>
										<div class="col-md-6">
											<div class="input-group">
											...
											<select class="form-control input-sm" id="editmthx_adiafani_g_type" onchange="mthx_adiafani_gtype();">
									...
									<div class="row">
										<div class="col-md-6">
											...
											<span class="input-group-addon">
												...
												<input type="text" id="editmthx_adiafani_b" class="form-control input-sm" />
											</div>
										</div>
										<div class="col-md-6">
											<div class="input-group">
											...
											<select class="form-control input-sm" id="editmthx_adiafani_b_type" onchange="mthx_adiafani_btype();">
												<option value=0>Χειροκίνητα</option>
									...
									<div class="row">
										<div class="col-md-5">
											<div class="input-group">
												...
												<input type="text" id="editmthx_adiafani_u" class="form-control input-sm" />
										...
										<div class="col-md-6">
											<div class="input-group">
												...
												<select class="form-control input-sm" id="editmthx_adiafani_u_id" onchange="mthx_adiafani_u();">
							...
							<div id="editmthx_adiafani_div_edafos" style="display:inline;">
							<table class="table table-bordered table-condensed">
								<tr class="info">
									<td colspan="3">
										Έδαφος 
								...
								<tr>
									<td>
										...
										<input type="text" id="editmthx_adiafani_z1" class="form-control input-sm" />
										</div>
									</td>
									...
									<td>
										...
										<input type="text" id="editmthx_adiafani_z2" class="form-control input-sm" />
										</div>
									</td>
								</tr>
							</table>
								...
								<tr>
									<td>
										<div class="input-group">
											...
											<input type="text" id="editmthx_adiafani_l" class="form-control input-sm" />
										</div>
									</td>
								</tr>
								<tr>
									<td>
										<div class="input-group">
											...
											<input type="text" id="editmthx_adiafani_h" class="form-control input-sm" />
										</div>
									</td>
								</tr>
								<tr>
									<td>
										<div class="input-group">
											...
											<input type="text" id="editmthx_adiafani_d" class="form-control input-sm" />
										</div>
									</td>
								</tr>
								<tr>
									<td>
										<div class="input-group">
											...
											<input type="text" id="editmthx_adiafani_dy" class="form-control input-sm" />
										</div>
									</td>
								</tr>
								<tr>
									<td>
										<div class="input-group">
											...
											<input type="text" id="editmthx_adiafani_dx" class="form-control input-sm" />
										</div>
									</td>
								</tr>
								<tr class="info">
									<td>
										<div class="input-group">
											...
											<input type="text" id="editmthx_adiafani_roof" class="form-control input-sm" />
										</div>
									</td>
								</tr>
								<tr class="info">
									<td>
										<div class="input-group">
											...
											<input type="text" id="editmthx_adiafani_draw_order" class="form-control input-sm" />
										</div>
									</td>
								</tr>
							</table>
							
						<div id="editmthx_adiafani_div_ae">
							<table class="table table-bordered table-condensed">
								<tr class="info">
									<td colspan="2">
										Ακτινοβολία 
								...
								<tr>
									<td>
										<div class="input-group">
											...
											<select class="form-control input-sm" id="editmthx_adiafani_ap">
												<?php
								...
								<tr>
									<td>
										<div class="input-group">
											...
											<select class="form-control input-sm" id="editmthx_adiafani_ek">
												<?php
						...
						<script>
						$('#editmthx_adiafani_div_edafos a').popover({ html:true, trigger:'click' });
						</script>
						</td>
					</tr>
				</table>
			...
			<div class="tab-pane" id="tab_modal_mthx_2">
				<table class="table table-bordered">
					...
					<td>
						<div class="row">
							<div class="col-md-8">
								...
								<input type="text" id="editmthx_adiafani_per" class="form-control input-sm" onchange="mthx_adiafani_per()"/>
								<span class="input-group-addon">%</span>
								</div>
							</div>
							<div class="col-md-4">
								<button class="btn btn-warning btn-xs" data-toggle="modal" data-target="#help_mthx_per">
					...
					<td>
						...
						<i class="fa fa-exchange text-danger"></i></button>
					</td>
					</tr>
					...
					<td>
						<input type="hidden" id="editmthx_adiafani_yp_counter">
						<div id="editmthx_adiafani_ypostylwmata">
							<div id="row_mthx_yp_1">
							<div class="row">
								<div class="col-md-5">
									<div class="input-group">
										<span class="input-group-addon">
									...
									<input type="text" id="editmthx_adiafani_yp_1" class="form-control input-sm" value="" placeholder="Μήκος" />
								...
								<div class="col-md-5">
									...
									<input type="text" id="editmthx_adiafani_yp_ar_1" class="form-control input-sm" value="" placeholder="Απόσταση από αρ. άκρο" />
									<span class="input-group-addon">m</span>
									</div>
								</div>
								<div class="col-md-2">
									<button class="btn btn-success btn-sm" type="button" onclick="add_mthx_yp()"><i class="fa fa-plus"></i></button>
								</div>	
							</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<input type="text" id="editmthx_adiafani_yp_u" class="form-control input-sm" />
							<span class="input-group-addon"> W/m<sup>2</sup>.K</span>
							</div>
						</div>
						<div class="col-md-6">
							...
							<select class="form-control input-sm" id="editmthx_adiafani_yp_u_id" onchange="mthx_adiafani_yp_u();">
								<option value=0>Χωρίς υπολογισμό</option>
								<?php
								echo create_select_optionsid("user_adiafani","name",array("user_id"=>$_SESSION["user_id"]) );
								?>
					...
					<td>
						<input type="hidden" id="editmthx_adiafani_dok_counter">
						<div id="editmthx_adiafani_dokoi">
							<div id="row_mthx_dok_1">
								<div class="row">
									<div class="col-md-5">
										<div class="input-group">
										<span class="input-group-addon">
										...
										<input type="text" id="editmthx_adiafani_dok_1" class="form-control input-sm" value="" placeholder="Ύψος" />
										<span class="input-group-addon">m</span>
										</div>
									</div>
									<div class="col-md-5">
										...
										<input type="text" id="editmthx_adiafani_dok_top_1" class="form-control input-sm" value="" placeholder="Απόσταση από κορυφή" />
										<span class="input-group-addon">m</span>
										</div>
									</div>
									<div class="col-md-2">
										<button class="btn btn-success btn-sm" type="button" onclick="add_mthx_dok()"><i class="fa fa-plus"></i></button>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="input-group">
									...
									<input type="text" id="editmthx_adiafani_dok_u" class="form-control" />
									<span class="input-group-addon"> W/m<sup>2</sup>.K</span>
								</div>
							</div>
							<div class="col-md-6">
								<div class="input-group">
									...
									<select class="form-control" id="editmthx_adiafani_dok_u_id" onchange="mthx_adiafani_dok_u();">
										<option value=0>Χωρίς υπολογισμό</option>
										<?php
										echo create_select_optionsid("user_adiafani","name",array("user_id"=>$_SESSION["user_id"]) );
										?>
			...
			<div class="tab-pane" id="tab_modal_mthx_3">
				<table class="table table-bordered table-condensed">
					<tr class="info">
						<td width=60%>
					...
					<tr>
						<td>
							<input type="hidden" id="editmthx_adiafani_syr_counter">
							<div id="editmthx_adiafani_syromena">
								<div id="row_mthx_syr_1">
									<div class="row">
										<div class="col-md-5">
											<div class="input-group">
												<span class="input-group-addon">
												...
												<input type="text" id="editmthx_adiafani_syr_w_1" class="form-control input-sm" value="" />
												<span class="input-group-addon">m</span>
											</div>
											<div class="input-group">
												<span class="input-group-addon">
												...
												<input type="text" id="editmthx_adiafani_syr_h_1" class="form-control input-sm" value="" />
												<span class="input-group-addon">m</span>
											</div>
										</div>
										<div class="col-md-5">
											<div class="input-group">
												...
												<input type="text" id="editmthx_adiafani_syr_p_1" class="form-control input-sm" value="" />
												<span class="input-group-addon">m</span>
											</div>
											<div class="input-group">
												<span class="input-group-addon">
												...
												<input type="text" id="editmthx_adiafani_syr_ar_1" class="form-control input-sm" value="" />
												<span class="input-group-addon">m</span>
											</div>
										</div>
										<div class="col-md-2">
											<button class="btn btn-success btn-sm" type="button" onclick="add_mthx_syr()"><i class="fa fa-plus"></i></button>
										</div>
									</div>	
								</div>
							</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="input-group">
									...
									<input type="text" id="editmthx_adiafani_syr_u" class="form-control input-sm" />
									<span class="input-group-addon"> W/m<sup>2</sup>.K</span>
								</div>
							</div>
							<div class="col-md-6">
								<div class="input-group">
									...
									<select class="form-control input-sm" id="editmthx_adiafani_syr_u_id" onchange="mthx_adiafani_syr_u();">
										<option value=0>Χωρίς υπολογισμό</option>
										<?php
										echo create_select_optionsid("user_adiafani","name",array("user_id"=>$_SESSION["user_id"]) );
										?>
			...
			<div class="tab-pane" id="tab_modal_mthx_4">
			<div id="adiafani_ck_f">
			<form class="form-inline">
				<label class="checkbox inline"><input type="checkbox" id="editmthx_adiafani_ck_fhor" onchange="mthx_adiafani_showf();">F<sub>hor</sub></label>
				<label class="checkbox inline"><input type="checkbox" id="editmthx_adiafani_ck_fov" onchange="mthx_adiafani_showf();">F<sub>ov</sub></label>
				<label class="checkbox inline"><input type="checkbox" id="editmthx_adiafani_ck_fovt" onchange="mthx_adiafani_showf();">F<sub>ovt</sub></label>
				<label class="checkbox inline"><input type="checkbox" id="editmthx_adiafani_ck_ffin_l" onchange="mthx_adiafani_showf();">F<sub>fin_l</sub></label>
				<label class="checkbox inline"><input type="checkbox" id="editmthx_adiafani_ck_ffin_r" onchange="mthx_adiafani_showf();">F<sub>fin_r</sub></label>
				<label class="checkbox inline"><input type="checkbox" id="editmthx_adiafani_ck_fsh" onchange="mthx_adiafani_showf();">F<sub>sh</sub></label>
			</form>
			</div>
			<div id="adiafani_ck_f1">
				<select class="form-control input-sm" id="editmthx_adiafani_f_type" onchange="mthx_adiafani_changef();" >
				...
				<div id="editmthx_adiafani_fhor" style="display:none;">
					<table class="table table-bordered table-condensed">
						<tr class="info">
							<td colspan=2>
						...
						<tr>
							<td width=50%>
								...
								<input type="text" id="editmthx_adiafani_fhor_e" class="form-control input-sm" />
								<span class="input-group-addon">m</span>
								</div>
							</td>
							<td>
								...
								<input type="text" id="editmthx_adiafani_fhor_h" class="form-control input-sm" />
								<span class="input-group-addon">m</span>
								</div>
							</td>
						</tr>
				...
				<div id="editmthx_adiafani_fov" style="display:none;">
					<table class="table table-bordered table-condensed">
						<tr class="info">
							<td>
						...
						<tr>
							<td>
								...
								<input type="text" id="editmthx_adiafani_fov_l" class="form-control input-sm" />
								<span class="input-group-addon">m</span>
								</div>
							</td>
						</tr>
				...
				<div id="editmthx_adiafani_fovt" style="display:none;">
					<table class="table table-bordered table-condensed">
						<tr class="info">
							<td colspan=2>
						...
						<tr>
							<td>
								...
								<input type="text" id="editmthx_adiafani_fovt_l" class="form-control input-sm" />
								<span class="input-group-addon">m</span>
								</div>
							</td>
							<td>
								...
								<input type="text" id="editmthx_adiafani_fovt_h" class="form-control input-sm" />
								<span class="input-group-addon">m</span>
								</div>
							</td>
						</tr>
				...
				<div id="editmthx_adiafani_ffin_l" style="display:none;">
					<table class="table table-bordered table-condensed">
						<tr class="info">
							<td colspan="2">
						...
						<tr>
							<td>
								...
								<input type="text" id="editmthx_adiafani_ffin_l_dx" class="form-control input-sm" />
								<span class="input-group-addon">m</span>
								</div>
							</td>
							<td>
								...
								<input type="text" id="editmthx_adiafani_ffin_l_w" class="form-control input-sm" />
								<span class="input-group-addon">m</span>
								</div>
							</td>
						</tr>
				...
				<div id="editmthx_adiafani_ffin_r" style="display:none;">
					<table class="table table-bordered table-condensed">
						<tr class="info">
							<td colspan="2">
						...
						<tr>
							<td>
								...
								<input type="text" id="editmthx_adiafani_ffin_r_dx" class="form-control input-sm" />
								<span class="input-group-addon">m</span>
								</div>
							</td>
							<td>
								...
								<input type="text" id="editmthx_adiafani_ffin_r_w" class="form-control input-sm" />
								<span class="input-group-addon">m</span>
								</div>
							</td>
						</tr>
				...
				<div id="editmthx_adiafani_fsh" style="display:none;">
					<table class="table table-bordered table-condensed">
						<tr class="info">
							<td colspan="3">
						...
						<tr>
							<td>
								...
								<select id="editmthx_adiafani_fsh_type" class="form-control input-sm" />
							...
							<td>
								...
								<input type="text" id="editmthx_adiafani_fsh_l" class="form-control input-sm" />
								<span class="input-group-addon">m</span>
								</div>
							</td>
							<td>
								...
								<input type="text" id="editmthx_adiafani_fsh_h" class="form-control input-sm" />
								<span class="input-group-addon">m</span>
								</div>
							</td>
						</tr>
			...
			<div class="tab-pane" id="tab_modal_mthx_5">
				<table class="table table-bordered">
					<tr class="info">
						<td colspan="2">
						Θερμογέφυρες 
					...
					<tr>
						...
						<div class="row">
							<div class="col-md-6">
								...
								<select class="form-control input-sm" id="editmthx_adiafani_psi_dap_type" onchange="mthx_adiafani_psi_type(1);">
									<option value=""></option>
								</select>
								</div>
							</div>
							<div class="col-md-6">
								...
								<select class="form-control input-sm" id="editmthx_adiafani_psi_dap_u" onchange="mthx_adiafani_psi_img(1);" onkeyup="mthx_adiafani_psi_img(1);">
									<option value=0></option>
								</select>
								</div>
							</div>
						...
						<div id="editmthx_adiafani_psi_img">
							<div class="thumbnail">
					...
					<tr>
						...
						<div class="row">
							<div class="col-md-6">
								...
								<select class="form-control input-sm" id="editmthx_adiafani_psi_or_type" onchange="mthx_adiafani_psi_type(2);">
									<option value=""></option>
								</select>
								</div>
							</div>
							<div class="col-md-6">
								...
								<select class="form-control input-sm" id="editmthx_adiafani_psi_or_u" onchange="mthx_adiafani_psi_img(2);" onkeyup="mthx_adiafani_psi_img(2);">
									<option value=0></option>
								</select>
								</div>
							</div>
					...
					<tr>
						...
						<div class="row">
							<div class="col-md-6">
								...
								<select class="form-control input-sm" id="editmthx_adiafani_psi_yp_type" onchange="mthx_adiafani_psi_type(3);">
									<option value=""></option>
								</select>
								</div>
							</div>
							<div class="col-md-6">
								...
								<select class="form-control input-sm" id="editmthx_adiafani_psi_yp_u" onchange="mthx_adiafani_psi_img(3);" onkeyup="mthx_adiafani_psi_img(3);">
									<option value=0></option>
								</select>
								</div>
							</div>
					...
					<tr>
						...
						<div class="row">
								...
								<select class="form-control input-sm" id="editmthx_adiafani_psi_dok_type" onchange="mthx_adiafani_psi_type(4);">
									<option value=""></option>
								</select>
								</div>
							</div>
							<div class="col-md-6">
								...
								<select class="form-control input-sm" id="editmthx_adiafani_psi_dok_u" onchange="mthx_adiafani_psi_img(4);" onkeyup="mthx_adiafani_psi_img(4);">
									<option value=0></option>
								</select>
								</div>
							</div>
					...
					<tr>
						...
						<div class="row">
							<div class="col-md-6">
								...
								<select class="form-control input-sm" id="editmthx_adiafani_psi_syr_type" onchange="mthx_adiafani_psi_type(5);">
									<option value=""></option>
								</select>
								</div>
							</div>
							<div class="col-md-6">
								...
								<select class="form-control input-sm" id="editmthx_adiafani_psi_syr_u" onchange="mthx_adiafani_psi_img(5);" onkeyup="mthx_adiafani_psi_img(5);">
									<option value=0></option>
								</select>
								</div>
							</div>
			...
			<div class="tab-pane" id="tab_modal_mthx_6">
				<table class="table table-bordered">
				<tr class="info">
				...
				<tr>
					<td>
						<div class="thumbnail">
							<div id="editmthx_adiafani_preview1">
					...
					<td>
						<div class="thumbnail">
							<div id="editmthx_adiafani_preview2">
								<img src="images/shading/fov.png">
							</div>
						</div>
					</td>
					<td>
						<div class="thumbnail">
							<div id="editmthx_adiafani_preview3">
								<img src="images/shading/fov.png">
							</div>
						</div>
					</td>
...
<div class="modal-footer">	
	<span id="edit_button_mthx_adiafani"></span>
...
<!-- ###################### Κρυφό modal_del_mthx_adiafani για εμφάνιση ###################### -->
<div id="modal_del_mthx_adiafani" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
<div class="modal-dialog">
<div class="modal-content">
<div class="modal-header">
	<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
...
<div class="modal-footer">	
	<span id="del_button_mthx_adiafani"></span>
	<button class="btn" data-dismiss="modal" aria-hidden="true">Άκυρο</button>
</div>
</div>
</div>
...
<!-- ######################### Κρυφό div για εμφάνιση ######################### -->
<!-- Modal -->
<div id="help_mthx_per" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
		...
		<div class="modal-body">
			Έτος κατασκευής:
			<select class="form-control input-sm"  id="editmthx_adiafani_per1" onchange="mthx_adiafani_help_per() ">
				<option value=1>Πριν το 1981</option>
				<option value=2>1981-1999</option>
			</select>
			Όροφοι:
			<select class="form-control input-sm"  id="editmthx_adiafani_per2" onchange="mthx_adiafani_help_per() ">
				<option value=1>Έως 2</option>
				<option value=2>2<οροφοι<5</option>
				<option value=3>>=5</option>
			</select>
			%:
			<input  class="form-control input-sm" id="editmthx_adiafani_per4"/>
		</div>
		<div class="modal-footer">
			<button type="button" class="btn btn-default" data-dismiss="modal">Κλείσιμο</button>
			<button type="button" class="btn btn-primary" data-dismiss="modal" onclick="mthx_adiafani_use_per4()">Προσθήκη</button>
		</div>
	</div>
</div>
</div>
<!-- ######################### Κρυφό div για εμφάνιση ######################### -->
<script>
document.getElementById("editmthx_adiafani_yp_counter").value=1;
document.getElementById("editmthx_adiafani_dok_counter").value=1;
document.getElementById("editmthx_adiafani_syr_counter").value=1;

function add_mthx_yp() {
var mthx_yp = document.getElementById("editmthx_adiafani_yp_counter").value;
mthx_yp ++;
var row = '<div id="row_mthx_yp_'+mthx_yp+'"><div class="row">';
//Μήκος υποστυλώματος
...
row += '</span>';
row += '<input type="text" id="editmthx_adiafani_yp_'+mthx_yp+'" class="form-control input-sm" value="">';
...
row += '</span>';
row += '<input type="text" id="editmthx_adiafani_yp_ar_'+mthx_yp+'" class="form-control input-sm" value="">';
row += '<span class="input-group-addon">m</span>';
row += '</div>';
row += '</div>';
//Κουμπί προσθήκης
...
row += '<button class="btn btn-danger btn-sm" type="button" onclick="rem_mthx_yp('+mthx_yp+')"><i class="glyphicon glyphicon-remove"></i></button>';
row += '</span>';
row += '</div>';
row += '</div></div>';
jQuery('#editmthx_adiafani_ypostylwmata').append(row);
$('#editmthx_adiafani_yp_counter').val(mthx_yp);
}

function rem_mthx_yp(mthx_yp) {
jQuery('#row_mthx_yp_'+mthx_yp).remove();
}

function add_mthx_dok() {
var mthx_dok = document.getElementById("editmthx_adiafani_dok_counter").value;
mthx_dok ++;
var row = '<div id="row_mthx_dok_'+mthx_dok+'"><div class="row">';
row += '<div class="col-md-5">';
row += '<div class="input-group">';
row += '<span class="input-group-addon">';
row += '<span class="tip-top" href="#" title="Το καθαρό ύψος της δοκού σε m"><i class="fa fa-arrows-v"></i> Ύψος</span>';
row += '</span>';
row += '<input type="text" id="editmthx_adiafani_dok_'+mthx_dok+'" class="form-control input-sm" value="">';
row += '<span class="input-group-addon">m</span>';
row += '</div>';
row += '</div>';
row += '<div class="col-md-5">';
...
row += '</span>';
row += '<input type="text" id="editmthx_adiafani_dok_top_'+mthx_dok+'" class="form-control input-sm" value="">';
row += '<span class="input-group-addon">m</span>';
row += '</div>';
row += '</div>';
row += '<div class="col-md-2">';
row += '<button class="btn btn-danger btn-sm" type="button" onclick="rem_mthx_dok('+mthx_dok+')"><i class="glyphicon glyphicon-remove"></i></button>';
row += '</div>';
row += '</div></div>';
jQuery('#editmthx_adiafani_dokoi').append(row);
$('#editmthx_adiafani_dok_counter').val(mthx_dok);
}

function rem_mthx_dok(mthx_dok) {
jQuery('#row_mthx_dok_'+mthx_dok).remove();
}

function add_mthx_syr() {
var mthx_syr = document.getElementById("editmthx_adiafani_syr_counter").value;
mthx_syr ++;
var row = '<div id="row_mthx_syr_'+mthx_syr+'"><div class="row">';
row += '<hr/>';
row += '<div class="col-md-5">';
//Μήκος συρόμενου
row += '<div class="input-group">';
...
row += '</span>';
row += '<input type="text" id="editmthx_adiafani_syr_w_'+mthx_syr+'" class="form-control input-sm" value="">';
row += '</div>';
//Ύψος συρόμενου
row += '<div class="input-group">';
row += '<span class="input-group-addon">';
...
row += '</span>';
row += '<input type="text" id="editmthx_adiafani_syr_h_'+mthx_syr+'" class="form-control input-sm" value="">';
row += '</div>';
row += '</div>';
row += '<div class="col-md-5">';
//Ποδιά συρόμενου
...
row += '</span>';
row += '<input type="text" id="editmthx_adiafani_syr_p_'+mthx_syr+'" class="form-control input-sm" value="">';
row += '</div>';
...
row += '</span>';
row += '<input type="text" id="editmthx_adiafani_syr_ar_'+mthx_syr+'" class="form-control input-sm" value="">';
row += '</div>';
row += '</div>';
row += '<div class="col-md-2">';
row += '<button class="btn btn-danger btn-sm" type="button" onclick="rem_mthx_syr('+mthx_syr+')"><i class="glyphicon glyphicon-remove"></i></button>';
row += '</div>';
row += '</div></div>';
jQuery('#editmthx_adiafani_syromena').append(row);
$('#editmthx_adiafani_syr_counter').val(mthx_syr);
}

function rem_mthx_syr(mthx_syr) {
jQuery('#row_mthx_syr_'+mthx_syr).remove();
}

//thermotype: έχει οριστεί στο menu_meleti_zone_adiafani.php το οποίο περιλαμβάνεται νωρίτερα
document.getElementById("editmthx_adiafani_psi_dap_type").innerHTML=thermotype;
document.getElementById("editmthx_adiafani_psi_or_type").innerHTML=thermotype;
document.getElementById("editmthx_adiafani_psi_yp_type").innerHTML=thermotype;
document.getElementById("editmthx_adiafani_psi_dok_type").innerHTML=thermotype;
document.getElementById("editmthx_adiafani_psi_syr_type").innerHTML=thermotype;
</script>
